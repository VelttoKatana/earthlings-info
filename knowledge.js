...
=== TOKENS ===
$STEAM: ID 0.0.3210123 | launched May 2024 | 1B supply | MEXC + SaucerSwap
...
Towns & Villages, City Plots (~$100-200 in STEAM), Land Plots, Avatar NFTs, Apparatus (gear), Stamps, Hunt Pins, EARTH-INO-GOLD (burnable for 75k STEAM).
...
=== HEDERA ===
Under 4 sec transactions. Fees tiny (2M tokens sent = $2.70). PoS, BFT security. Uses HTS not ERC-721.
...
=== TEAM ===
Patrick & Marcel de Grijs (20+ yrs design), Jorgo Wildeboer (software).
